...
export const EXPORT_COLUMNS = {
  ...
  memberships: [
    ...
    { key: 'effective_end_date', label: 'Fin efectivo', format: 'date' },
    { key: 'membership_status.label', label: 'Estado' },
    { key: 'is_current', label: 'Registro más reciente' },
  ],
  ...
  schedules: [
    ...
    { key: 'paid_amount', label: 'Monto pagado', format: 'currency' },
    { key: 'outstanding_amount', label: 'Saldo', format: 'currency' },
    { key: 'is_paid', label: 'Pagado' },
    { key: 'collection_status.label', label: 'Estado cobranza' },
    { key: 'has_collection_management', label: 'En gestión' },
